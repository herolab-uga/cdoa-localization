...
# node_pos=[(-node_positions[0],-node_positions[1]),(-node_positions[0],node_positions[1]),(node_positions[0],-node_positions[1])] # for 3 nodes
initial_pos=(0,0)
...
for i in range(0,len(overall_rss)):
    ...
    # print(str(overall_rss[i]))
        ...
        # gx = ((overall_rss[i][2]-overall_rss[i][0])/72)
        # gy = ((overall_rss[i][1]-overall_rss[i][0])/72)
...
for i in range(0,len(original_tragectory)):
    ...
    for particle in particles:
        ...
        # gx = ((actual_rss[2]-actual_rss[0])/72)
        # gy = ((actual_rss[1]-actual_rss[0])/72)
...
resultFile = open("error_boundry_particleFilter_full(6by6).csv", "a")  # append mode
